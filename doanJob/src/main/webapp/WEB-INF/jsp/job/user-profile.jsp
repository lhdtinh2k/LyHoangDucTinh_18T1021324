                        ...
                        <div class="widget">
                            ...
                            <ul class="nav service-menu">
                                ...
                                <c:if test="${profileUser.roles == 'investors'}">
                                    <li><a href="/investor/timViec">Đăng ký tìm việc</a></li>
                                </c:if>
                                <c:if test="${profileUser.roles == 'startup'}">
                                    <li><a href="/job/saveProject">Đăng bài tuyển việc làm</a></li>
                                    <li><a href="/user/userListProject">Các bài đã đăng</a></li>
<%--                                    <li><a href="/job/acceptInvestion">Các yêu cầu đầu tư</a></li>--%>
                                </c:if>
                            </ul>
                        </div><!-- Widget end -->
