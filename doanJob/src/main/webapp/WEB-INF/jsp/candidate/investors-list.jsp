                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="banner-heading">
                            <h2 class="banner-title" style="color: black;opacity: 1">Ứng viên</h2>
                        </div>
                    </div><!-- Col end -->
                </div><!-- Row end -->
            </div><!-- Container end -->
        ...
        <div class="container">
            <div class="row subpage">
                <div class="col-sm-12 left">
                    <div class="navigation"><a style="font-weight: bold" href="/"><i class="fas fa-home"></i>Trang chủ > </a><a style="font-weight: bold" href="#">Ứng viên</a></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-3 item">
                                <div>
                                        ...
                                        <a href="/investor/details/${investors.id}" ><img src="/ndt/images/nhadautu/${investors.logo}" alt="Ảnh" style="height: 140px;"></a>
                                        <div class="item_b">
